...
const FALLBACK_PRODUCTS = [
  ...
  {id:"P008",name:"علبة مجوهرات مخملية بمرآة",category:"حقائب ومنظمات سفر",subcategory:"علب",description:"علبة صغيرة فاخرة بمرآة داخلية، مثالية للسفر والهدايا.",price:9200,old_price:12000,discount:23,image:"https://images.unsplash.com/photo-1589128777073-263566ae5e4d?w=600",images:"",stock:30,featured:false,badge:"جديد",rating:4.8,sku:"SYM-008",availability:"متوفر"},
];
